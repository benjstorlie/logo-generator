...
class Logo {
  ...
  textRender() {
    if (this.shape instanceof Triangle) {
      ...
      // y = "121" makes the text about vertically centered in a square or circle.
      return `<text x="150" y="121" font-size="${this.fontSize}" font-family="sans-serif" text-anchor="middle" fill="${this.textColor}">${this.text}</text>`
    }
