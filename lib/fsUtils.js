...
/**
 * Reformats the title to be a  filename.  This way different projects won't be saved with the same name.  If no title is given, the default will be 'logo'.
 * @param {String} title 
 * @returns {String} reformatted title
 */
